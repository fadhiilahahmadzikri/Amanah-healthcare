...
const MOCK_USERS_FAKER_SEED = 20260202;
const MOCK_USERS_REF_DATE = new Date('2026-06-22T00:00:00.000Z');
...
export const fakeUsers = {
  ...
  initialize() {
    faker.seed(MOCK_USERS_FAKER_SEED);
    faker.setDefaultRefDate(MOCK_USERS_REF_DATE);
