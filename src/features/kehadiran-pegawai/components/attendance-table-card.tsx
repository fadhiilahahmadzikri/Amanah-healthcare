...
export function AttendanceTableCard({
  ...
  return (
    <div
      className={cn(
        'flex flex-col justify-between h-full font-sans select-none space-y-4',
        className
      )}
    >
        ...
        <div className='flex flex-wrap items-center justify-between gap-2.5'>
          <div className='flex flex-1 flex-wrap items-center gap-2'>
            ...
            <Select
              ...
              onValueChange={(val) =>
                onFilterChange({ shift: val === 'all' ? null : val, page: 1 })
              }
            >
            ...
            <Select
              ...
              onValueChange={(val) =>
                onFilterChange({ status: val === 'all' ? null : val, page: 1 })
              }
            >
