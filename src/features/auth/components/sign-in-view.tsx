      ...
      <div className='relative hidden h-full flex-col p-10 lg:flex dark:border-r'>
        ...
        <div className='relative z-20 mt-auto text-white'>
          <blockquote className='space-y-2'>
            <p className='text-lg'>
              &ldquo;Pantau stok secara real-time, otomatisasi proses inventaris, dan tingkatkan
              produktivitas bisnis secepat kilat.&rdquo;
            </p>
            <footer className='text-sm text-white/70'>Wayan wisnu suwibawe</footer>
          </blockquote>
        </div>
      </div>
