...
export default function NotificationsPage() {
  ...
  return (
    ...
    >
      <div className='flex flex-col flex-1 w-full space-y-4 font-sans select-none'>
        ...
        {paginatedList.length > 0 ? (
                ...
                <table className='w-full text-left text-xs font-normal'>
                  ...
                  <thead className='bg-muted/40 border-b border-border text-foreground font-semibold text-xs'>
                    <tr>
                      ...
                      <th className='py-3 px-3 font-semibold text-xs text-foreground'>Kategori</th>
                      <th className='py-3 px-3 font-semibold text-xs text-foreground'>Status</th>
                      <th className='py-3 px-3 font-semibold text-xs text-foreground'>Waktu</th>
          ...
          <div className='bg-card rounded-xl p-10 text-center border border-border shadow-none space-y-3 flex flex-col items-center justify-center'>
            ...
            <div className='space-y-1'>
              <h3 className='text-sm font-bold text-foreground'>Tidak ada notifikasi ditemukan</h3>
        ...
        {/* 3. Reusable AppointmentPagination Component from Janji Temu */}
