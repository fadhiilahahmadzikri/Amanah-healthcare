                      ...
                      {STATUS_OPTIONS.map((opt) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span
                              className={cn(
                                "size-2 rounded-full mr-1.5 shrink-0",
                                opt.dotColor,
                              )}
                            />
                            <span>{opt.label}</span>
                        ...
                        <table className="w-full text-left text-xs font-normal">
                          ...
                          <tbody className="divide-y divide-border/60">
                            {paginatedList.map((item) => {
                              ...
                              const catConf = getCategoryTagConfig(
                                item.category,
                              );
                                    ...
                                    {isUnread ? (
                                      ...
                                      >
                                        ...
                                        <span
                                          className={cn(
                                            "bg-clip-text text-transparent font-bold tracking-tight",
                                            clinicalTokens.colors.status
                                              .confirmed.textGradient,
                                          )}
                                        >
                                          Belum Dibaca
                                        </span>
                                  ...
                                  <td className="py-3 px-3 text-right">
                                    <Button
                                      ...
                                      onClick={() => {
                                        markAsRead(item.id);
                                        toast.info(
                                          `Detail notifikasi dari ${item.sender}`,
                                          {
                  ...
                  <div className="bg-card rounded-xl p-10 text-center border border-border shadow-none space-y-3 flex flex-col items-center justify-center">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground max-w-xs mx-auto">
                        Coba sesuaikan filter kategori, status, atau kata kunci
                        pencarian kamu.
                      </p>
                    </div>
                    <Button
